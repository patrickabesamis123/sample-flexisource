...
<li role="tab" class="active">
    <a href="/features/candidates#employers" data-target="#featuredBanner1, #employers" role="tab" data-toggle="tab" class="tabnav2" aria-expanded="false">Features for Employers</a>
</li>
<li role="tab" class="">
    <a href="/features/candidates#candidates" data-target="#featuredBanner2, #candidates" role="tab" data-toggle="tab" class="tabnav1" aria-expanded="true">Features for Candidates</a>
</li>
</ul>
</div>
...
<ul>
<li class="ng-scope">
<a href="/features/candidates#scroll1" class="slideme ng-binding">Pre-Application Assessment</a>
</li>
<li class="ng-scope">
<a href="/features/candidates#scroll2" class="slideme ng-binding">Video</a>
</li>
<li class="ng-scope active col-md-offset-1">
<a href="/features/candidates#scroll3" class="slideme ng-binding">Profile</a>
</li>
<li class="ng-scope">
<a href="/features/candidates#scroll4" class="slideme ng-binding">TMS</a>
</li>
<li class="ng-scope">
<a href="/features/candidates#scroll5" class="slideme ng-binding">Dashboards</a>
</li>
<li class="ng-scope">
<a href="/features/candidates#scroll6" class="slideme ng-binding">Messaging</a>
</li>
<li class="ng-scope">
<a href="/features/candidates#scroll7" class="slideme ng-binding">Social Media Sharing</a>
</li>
</ul>
</div>
</div>
...
<ul>
<li class="ng-scope">
<a href="/features/candidates#scroll8" class="slideme ng-binding">Data insights</a>
</li>
<li class="ng-scope">
<a href="/features/candidates#scroll9" class="slideme ng-binding">Teams</a>
</li>
<li class="ng-scope active col-md-offset-1">
<a href="/features/candidates#scroll10" class="slideme ng-binding">Pricing</a>
</li>
</ul>
</div>
</div>
...
<ul class="carouselthis">
    ...
    <li class="ng-scope">
        <a href="/features/candidates#c_scroll1" class="slideme ng-binding">Video</a>
    ...
    <li class="ng-scope">
        <a href="/features/candidates#c_scroll5" class="slideme ng-binding">Messaging and notifications</a>
    </li><!-- end ngRepeat: (key, val) in CandidateNav -->
    <li class="ng-scope">
        <a href="/features/candidates#c_scroll6" class="slideme ng-binding">Privacy</a>
    </li><!-- end ngRepeat: (key, val) in CandidateNav -->
    <li class="ng-scope">
        <a href="/features/candidates#c_scroll7" class="slideme ng-binding">Pricing</a>
    </li><!-- end ngRepeat: (key, val) in CandidateNav -->
</ul>
</div>
</div>
...
<a href="/features/candidates#" class="glyphicon glyphicon-circle-arrow-up backtoTop" style="display: none;"><br><span>Back to top</span> </a>
</div>
</div>
</div>
</div>
