...
?>
<div ng-controller="JoblistingController" id="JobListing" ng-cloak>
  ...
  <div ng-show="joblisting">
    ...
    <div ng-if="!joblisting.company.company_banner_url" class="company_banner" style="background-image: url('/images/Default-Header.png');"></div>
    <input type="hidden" id="job-listing-id" value="{$jobId}" />
    <div id="job-listing-top-con" class="container-fluid"  >
      <div class="row">
        <div class="container">
          <div class="row">
            <div id="job-listing-logo-con1" class="col-md-2 text-xs-center">
              <a href="/company/@{{joblisting.company.company_url}}">
                <img ng-if="joblisting.company.logo_url" class="img-circle" ng-src="@{{joblisting.company.logo_url}}" height="150px" width="150px" />
                <!-- <img ng-if="!joblisting.company.logo_url" class="img-circle" src="/images/default_company_logo.png" height="150px" width="150px" /> -->
            ...
            <div id="job-listing-title-con1" class="col-md-5 text-xs-center">
              <h3 class="pvm-blue">
                <a href="/company/@{{joblisting.company.company_url}}" class="no-visited">@{{joblisting.company.company_name}}</a>
              </h3>
              <h4>@{{joblisting.job_title}}</h4>
              <h5>@{{joblisting.company.industry.data.industry.display_name}}</h5>
              <div class="col-md-12 job-listing-icons-con" style="margin-left:-25px">
                <div class="job-listing-icons">
                  <div class="image_con">
                    <img class="job-listing-icon1" ng-src="/images/job-listing-icon1.png" />
                  </div>
                  <p>
                    <small>
                ...
                <div class="job-listing-icons" ng-show="joblisting.is_salary_public && joblisting.salary_notes != null">
                  <div class="image_con">
                    <img class="job-listing-icon2" ng-src="/images/job-listing-icon2.png" />
                  </div>
                   <p>
                ...
                <div class="job-listing-icons" ng-if="joblisting.start_time || joblisting.finish_time || joblisting.flexible_hours">
                  <div class="image_con">
                    <img class="job-listing-icon3" ng-src="/images/job-listing-icon3.png" />
                  </div>
                  <p>
                ...
                <div class="job-listing-icons">
                  <div class="image_con">
                    <img class="job-listing-icon2" ng-src="/images/icons/parttime.png" />
                  </div>
                  <p>
                  	<small>@{{joblisting.role_type.displayName}}</small>
                  </p>
                </div>
                <div class="job-listing-icons">
                  <div class="image_con">
                    <img class="job-listing-icon2" ng-src="/images/icons/highPotential.png" />
                  </div>
                  <p>
                  	<small>
                      @{{joblisting.min_experience}} - @{{joblisting.max_experience}}y
                    </small>
                  </p>
                </div>
    ...
    <div class="container-fluid" id="job-listing-content-con1">
      <div class="row">
        <div class="container">
          <div id="job-listing-buttons-holder" class="col-md-7">
            <div  class="row" >
              <div id="job_listed_con">
                <div id="job_listed_holder">
                  <div class="job_listed">
                    <div>JOB LISTED</div>
                    <div>@{{ joblisting.job_listed_date }}</div>
                  </div>

                  <div class="job_listed">
                    <div>LISTING EXPIRES</div>
                    <div>@{{ joblisting.listing_expired_date }}</div>
                  </div>
                </div>
                <br>
            ...
            <div class="job-listing-left-content-holder">
              ...
              <div ng-show="showVideoLoding">
              	<video poster="/images/video_preload.gif"></video>
              </div>
            </div>
          ...
          <div class="job-listing-container3 container">
            ...
            <div class="job-listing-row1">
              <div class="pull-left " id="logo-con">
                <a href="/company/@{{joblisting.company.company_url}}">
                	<!-- <img ng-if="!joblisting.company.logo_url" ng-src="/images/default_company_logo.png" width="70px" class="img-circle" /> -->
              ...
              <div class="pull-left" id="video-con">
                ...
                <div ng-show="showVideoLoding">
                  <video poster="/images/video_preload.gif" style="width:276px;padding-bottom:10px"></video>
                </div>
                <br><br>
                ...
                <a href="/company/@{{joblisting.company.company_url}}" class="job-listing-question-button width-100 btn-see-profile"><i class="glyphicon glyphicon-eye-open"></i> See our full profile</a>
              </div>
              <div class="clearfix"></div>
            </div>
            <div class="job-listing-row2">
              <div class="more_listing_holder">
                ...
                <h5 class="pull-right"><a href="/job/search#?company_name=@{{joblisting.company.company_name}}" class="pvm-white no-change-color no-visited">See all jobs listed by @{{joblisting.company.company_name}}</a></h5>
              </div>
              <div class="clearfix"></div>
              <div class="row">
                <div class="col-md-4 " ng-repeat="job in joblisting.company_extra_data.active_jobs.results.jobs">
                  <div class="col-md-12 more-listing pvm-black" style="height:339px;overflow:hidden">
                    <h3 class="pvm-blue" style="height:27px;overflow:hidden">
                      <a href="/job/listing/@{{job.object_id}}" ng-bind-html="job.job_title_limit"></a>
                    </h3>
                    ...
                    <div class="col-md-6">
                      <a href="/company/@{{joblisting.company.company_url}}">
                        <img ng-if="job.company.logo_url" ng-src="@{{job.company.logo_url}}" width="30px" class="pull-left img-circle" />
                        <img ng-if="!job.company.logo_url" ng-src="/images/default_company_logo.png" width="30px" class="pull-left" />
	  ...
	  <div class="modal-dialog modal-sm shareMod" role="document">
	    <div class="modal-content">
		    <div class="container-fluid">
			    ...
			    <a href="javascript:void(0)" socialshare name="twitter" share-count socialshare-provider="twitter" socialshare-text="@{{joblisting.job_title}} @ @{{joblisting.company.company_name}}" socialshare-url="/job/listing/@{{joblisting.object_id}}" class="fa fa-twitter-square"></a>
			    <a href="javascript:void(0)" socialshare="" name="facebook" share-count socialshare-provider="facebook" socialshare-url="/job/listing/@{{joblisting.object_id}}" class="fa fa-facebook-square"></a>
			    <a href="javascript:void(0)" socialshare name="linkedin" share-count socialshare-provider="linkedin" socialshare-text="@{{joblisting.job_title}} @ @{{joblisting.company.company_name}}" socialshare-url="/job/listing/@{{joblisting.object_id}}" class="fa fa-linkedin-square"></a>
			    <a href="javascript:void(0)" socialshare name="email" share-count socialshare-provider="email" socialshare-text="@{{joblisting.job_title}} @ @{{joblisting.company.company_name}}" socialshare-url="/job/listing/@{{joblisting.object_id}}" class="fa fa-envelope-square"> </a>
		     </div>
		    </div>
	    </div>
	  </div>
...
<script type="text/javascript" src="js/ng/login/job-listing.js"></script>
