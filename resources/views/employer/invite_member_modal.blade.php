<script type="text/ng-template" id="inviteMember">

    <div class="" id="InviteTeamMember" >
      <div class="modal-header">
        <button type="button" class="close" ng-click="cancel()" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="ModalLabel">Invite Team Member</h4>
      </div>
       ...
       <ul class="addMember">
        ...
        <form   id="InviteMemberForm" name="InviteMemberForm" >
            ...
            <p>If you have additional team members that will be managing the recruiting process, you may add them here.</p>
                ...
                <div class="field text nolabel">
                    <input type="hidden" name="account_type" ng-model="user.account_type" ng-value="6" value="6">
        ...
        <div class="Actions">
         <hr class="divider" style="margin-bottom: 15px">
            <div class="inline-button step3buttons">
                ...
                <input type="submit" name="action_doNothing" value="Invite Member" class="action submitbluegreen right pull-right" id="Form_action_doNothing" ng-click="ok()" >
                <div class="clearfix"> </div>
