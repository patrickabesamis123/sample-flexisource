...
<title>PreviewMe</title>
<meta http-equiv="Content-type" content="text/html; charset=utf-8" />
<meta name="keywords" content="preview me, PvM, PreviewMe, previewme, pvm, candidate, candidates, employer, employers, job, jobs">
...
<link rel="stylesheet" href="css/jquery.datetimepicker.min.css?ver=1" />
<link rel="stylesheet" href="css/minified/style-employer.min.css" />
<link rel="stylesheet" href="css/homepage.css?ver=1.5" />
<link rel="stylesheet" href="css/media-queries.min.css?ver=2.0" />
<link rel="stylesheet" href="css/trackpad-scroll-emulator.min.css?ver=1" />
<link href="css/circle.css?ver=1" rel="stylesheet">
<link href="css/xeditable.css?ver=0.1.8" rel="stylesheet">
...
<link href="css/Jcrop-master/jquery.Jcrop.min.css?ver=0.9.12" rel="stylesheet">
<link href="//amp.azure.net/libs/amp/latest/skins/amp-default/azuremediaplayer.min.css?ver=1" rel="stylesheet">
<link href="js/angular/rzslider.css?ver=5.4.1" rel="stylesheet">
...
<script src="/js/recordRTC/recordRTC.js?ver=1" type="text/javascript"></script>
<script src="//amp.azure.net/libs/amp/2.1.0/azuremediaplayer.min.js?ver=2.1"></script>
<script src="js/jquery/jquery.drawPieChart.js?ver=0.3"></script>
...
src="https://www.facebook.com/tr?id=258829904566714&ev=PageView
&noscript=1"/>
</noscript> -->
...
<link rel="stylesheet" href="//code.jquery.com/mobile/1.4.5/jquery.mobile-1.4.5.min.css?ver=1.4.5">
@endif
...
<script type="text/javascript">
    ...
    a.src=document.location.protocol+"//script.crazyegg.com/pages/scripts/0024/5727.js?"+Math.floor(new Date().getTime()/3600000);
    a.async=true;a.type="text/javascript";b.parentNode.insertBefore(a,b)}, 1);
    </script>

@yield('styles')
<!-- <meta property="og:title" content="About Us | Previewme.co">
<meta property="og:site_name" content="Previewme">
<meta property="og:url" content="https://previewme.co/about-us/">
<meta property="og:image" content="https://previewme.co/themes/bbt/images/og_logo.png"> -->
</head>

@if (Request::segment(1) == "resources")
  <body class="BlogHolder resources" dir="ltr" ng-app="app" data-base_url="https://previewme.co/">
@elseif(Request::segment(1) == "resource")
  <body class="BlogPost" dir="ltr" ng-app="app" data-base_url="https://previewme.co/">
@elseif(Request::segment(1) == "login")
  <body class="Login login" dir="ltr" ng-app="app" data-base_url="https://previewme.co/">
@elseif(Request::segment(1) == "")
  <body class="Homepage home" dir="ltr" ng-app="app" data-base_url="https://previewme.co/">
@else
  <body class="StaticPages" dir="ltr" ng-app="app" data-base_url="https://previewme.co/">
@endif


<!-- <noscript>
  <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5VGT7HC"
height="0" width="0" style="display:none;visibility:hidden"></iframe>
</noscript> -->

@include('includes.employer_header')
@yield('content')
